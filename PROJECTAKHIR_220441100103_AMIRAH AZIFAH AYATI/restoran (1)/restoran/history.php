...
$data = query("SELECT * FROM transaksi WHERE id_user = $id_user");
                ...
                <div class="col-md-6 mb-5">
                    <div class="card ">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Total Pembayaran : 
                                <span class="font-weight-bold">Rp.<?php echo number_format($data['total_harga']);  ?></span>
                                <div><?php echo $data['status_order'] ?></div>
                            </p>
                            <hr>
                            <a href="detail_history.php?id_transaksi=<?php echo $data['id_transaksi']; ?>" class="btn btn-primary float-right">Detail Pesanan</a>
                        </div>
                    </div>
                </div>
            <?php
